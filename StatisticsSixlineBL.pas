...
function calcStatisticsSixlineLast(var statArrLast: array of Integer):BOOL;
var
...
function calcPercSixlineLocal(var statSixlinePerc: array of Double;
...
begin
  ...
  if (countNumber <= PercCount-1) then begin
    ...
    statSixlinePerc[ConstNum] := (Count * 100) / Divide;
  end else begin
...
function calcPercSixline(var statSixlinePerc: array of Double; PercCount: Integer):BOOL;
var
  i, Divide: integer;
begin
  Divide := 0;
  ...
  for i := 0 to 10 do begin
    calcPercSixlineLocal(statSixlinePerc, i, Divide, PercCount);
  end;
...
function calcStatisticsSixline():BOOL;
begin
  calcStatisticsSixlineLast(statSixlineLast);

  calcPercSixline(statSixlinePercFirst, getFirstPercCount);
  calcPercSixline(statSixlinePercSecond, getSecondPercCount);
  calcPercSixline(statSixlinePercThird, getThirdPercCount);
