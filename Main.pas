...
function clickToPosWindow(HWnd: THandle; X, Y, Count: Integer):BOOL;
var
  i: Integer;
begin
...
function setBetsToRulet(HWnd: THandle):BOOL;
var
  i: Integer;
begin
...
function setIntervalTimerAutoGame(millisecond: Cardinal):BOOL;
begin
  FormMain.TimerAutoGame.Enabled := False;
