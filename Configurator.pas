...
begin
  ...
  if strTypeBtnScan = 'ScanWindowRulet' then begin
    ...
    if HWnd <> 0 then begin
      ...
      addImageFromWindow(HWnd, ImageBtnSpinImg, PosInputWnd.X, PosInputWnd.Y);
    ...
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber0.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber1.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber2.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber3.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber4.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber5.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber6.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber7.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber8.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber9.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber10.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber11.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber12.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber13.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber14.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber15.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber16.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber17.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber18.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber19.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber20.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber21.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber22.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber23.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber24.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber25.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber26.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber27.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber28.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber29.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber30.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber31.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber32.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber33.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber34.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber35.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      addImageFromWindow(HWnd, ImageHashNumberImg, StrToInt(EditHashNumberPosX.Text), StrToInt(EditHashNumberPosY.Text));
      EditHashNumber36.Text := IntToStr(getHashFromImage(ImageHashNumberImg));
      strTypeBtnScan := '';
    end;
    ...
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditPairLowPosX.Text := IntToStr(PosInputWnd.X);
      EditPairLowPosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetPairHigh' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditPairHighPosX.Text := IntToStr(PosInputWnd.X);
      EditPairHighPosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetPairOdd' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditPairOddPosX.Text := IntToStr(PosInputWnd.X);
      EditPairOddPosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetPairEven' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditPairEvenPosX.Text := IntToStr(PosInputWnd.X);
      EditPairEvenPosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetPairRed' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditPairRedPosX.Text := IntToStr(PosInputWnd.X);
      EditPairRedPosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetPairBlack' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditPairBlackPosX.Text := IntToStr(PosInputWnd.X);
      EditPairBlackPosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetColumn2to11' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditColumn2To11PosX.Text := IntToStr(PosInputWnd.X);
      EditColumn2To11PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetColumn2to12' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditColumn2To12PosX.Text := IntToStr(PosInputWnd.X);
      EditColumn2To12PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetColumn2to13' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditColumn2To13PosX.Text := IntToStr(PosInputWnd.X);
      EditColumn2To13PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetDozen1st12' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditDozen1st12PosX.Text := IntToStr(PosInputWnd.X);
      EditDozen1st12PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetDozen2st12' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditDozen2st12PosX.Text := IntToStr(PosInputWnd.X);
      EditDozen2st12PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetDozen3st12' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditDozen3st12PosX.Text := IntToStr(PosInputWnd.X);
      EditDozen3st12PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber0' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber0PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber0PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber1' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber1PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber1PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber2' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber2PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber2PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber3' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber3PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber3PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber4' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber4PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber4PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber5' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber5PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber5PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber6' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber6PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber6PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber7' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber7PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber7PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber8' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber8PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber8PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber9' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber9PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber9PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber10' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber10PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber10PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber11' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber11PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber11PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber12' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber12PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber12PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber13' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber13PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber13PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber14' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber14PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber14PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber15' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber15PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber15PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber16' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber16PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber16PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber17' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber17PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber17PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber18' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber18PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber18PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber19' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber19PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber19PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber20' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber20PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber20PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber21' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber21PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber21PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber22' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber22PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber22PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber23' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber23PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber23PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber24' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber24PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber24PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber25' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber25PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber25PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber26' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber26PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber26PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber27' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber27PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber27PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber28' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber28PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber28PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber29' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber29PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber29PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber30' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber30PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber30PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber31' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber31PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber31PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber32' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber32PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber32PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber33' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber33PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber33PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber34' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber34PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber34PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber35' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber35PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber35PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetNumber36' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditNumber36PosX.Text := IntToStr(PosInputWnd.X);
      EditNumber36PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline1' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline1PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline1PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline2' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline2PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline2PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline3' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline3PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline3PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline4' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline4PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline4PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline5' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline5PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline5PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline6' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline6PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline6PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline7' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline7PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline7PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline8' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline8PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline8PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline9' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline9PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline9PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline10' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline10PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline10PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetSixline11' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditSixline11PosX.Text := IntToStr(PosInputWnd.X);
      EditSixline11PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet0' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet0PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet0PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet1' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet1PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet1PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet2' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet2PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet2PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet3' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet3PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet3PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet4' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet4PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet4PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet5' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet5PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet5PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet6' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet6PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet6PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet7' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet7PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet7PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet8' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet8PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet8PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet9' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet9PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet9PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet10' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet10PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet10PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet11' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet11PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet11PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet12' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet12PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet12PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetStreet13' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditStreet13PosX.Text := IntToStr(PosInputWnd.X);
      EditStreet13PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle0' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle0PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle0PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle1' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle1PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle1PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle2' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle2PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle2PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle3' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle3PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle3PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle4' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle4PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle4PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle5' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle5PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle5PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle6' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle6PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle6PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle7' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle7PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle7PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle8' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle8PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle8PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle9' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle9PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle9PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle10' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle10PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle10PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle11' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle11PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle11PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle12' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle12PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle12PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle13' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle13PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle13PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle14' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle14PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle14PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle15' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle15PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle15PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle16' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle16PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle16PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle17' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle17PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle17PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle18' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle18PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle18PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle19' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle19PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle19PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle20' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle20PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle20PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle21' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle21PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle21PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end else if strTypeBtnScan = 'ScanBetAngle22' then begin
    HWnd := getWindowRuletFromEdit();
    if HWnd <> 0 then begin
      PosInputWnd := getSubCoordinates(HWnd);
      EditAngle22PosX.Text := IntToStr(PosInputWnd.X);
      EditAngle22PosY.Text := IntToStr(PosInputWnd.Y);
    end;
  end;
end;
