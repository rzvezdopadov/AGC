...
begin
  ...
  if (FormSettings.CheckStreetEnabledST12.Checked and (position = 12)) then getSettStreetEnable := true;
  if (FormSettings.CheckStreetEnabledST13.Checked and (position = 13)) then getSettStreetEnable := true;
end;
